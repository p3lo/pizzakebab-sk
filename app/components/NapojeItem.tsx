    ...
    <div className="flex flex-row items-start justify-between space-x-5">
      <div className="flex flex-col">
        <div className="basis-4/5 flex text-base-300 space-x-1 items-center">
          <h2 className="font-bold text-lg">{napojeIndex}.</h2>
          <h2 className="font-bold text-lg">{napoje.name}</h2>
        </div>
        <p className="text-base-100/70 text-sm">{napoje.description}</p>
      </div>
      <div className="basis-1/5 flex space-x-3 items-center">
        <p className="text-base-100 w-[60px]">{napoje.price.toFixed(2)} €</p>
